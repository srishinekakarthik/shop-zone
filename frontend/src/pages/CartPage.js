  ...
  if (itemCount === 0) {
    return (
      <div style={styles.empty}>
        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 24 24" fill="none" stroke="#94a3b8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginBottom: '1rem' }}>
    ...
    <div className="container page">
      ...
      <div style={styles.layout}>
          ...
          {cart.items.map(item => (
            <div key={item.id} className="card" style={styles.item}>
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={styles.itemPrice}>₹{parseFloat(item.price)} each</p>
              </div>
              {/* Qty stepper */}
        ...
        <div className="card" style={styles.summary}>
          ...
          <div style={styles.summaryRow}><span>Subtotal</span><span>₹{cart.total}</span></div>
          ...
          <div style={{ ...styles.summaryRow, fontWeight: 800, fontSize: '1.15rem' }}>
            <span>Total</span><span style={{ color: '#2563eb' }}>₹{cart.total}</span>
          </div>
